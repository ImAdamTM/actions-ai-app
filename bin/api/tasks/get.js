 ...
 * @private
 */
exports.getIntents = props => new Promise((resolve, reject) => {
  request.get({
 ...
 * @private
 */
exports.getEntities = props => new Promise((resolve, reject) => {
  request.get({
 ...
 * @private
 */
exports.getIntentsAndEntities = props => new Promise((resolve, reject) => {
  Promise
    .all([
